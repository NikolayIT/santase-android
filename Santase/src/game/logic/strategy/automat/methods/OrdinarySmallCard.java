...
/**
 * OrdinarySmallCard class. PlayCardMethod which implements the logic of playing
 * a small card.
 * 
...
public final class OrdinarySmallCard extends BaseMethod {
	...
	protected Card getPlayMethodCard(final Player player) {
		...
		// !!!
		if (getRival(player).getPlayedCard() != null && getRival(player).getPlayedCard().getRank().equals(Rank.King) && result != null && result.getRank().equals(Rank.Queen)
